    ...
    return (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
            ...
            <div className="relative bg-white rounded-2xl w-full max-w-[480px] p-7 shadow-2xl animate-in fade-in zoom-in-95 duration-200">
                <h3 className="text-[16px] font-bold text-[#0C0C0E] mb-5">Add staff member</h3>
                    ...
                    {([
                        ...
                        <div key={k}>
                            ...
                            <input
                                ...
                                onChange={set(k)}
                                placeholder={label}
                                className="w-full h-10 border border-gray-200 rounded-xl px-3 text-[13px] font-medium text-[#0C0C0E] placeholder:text-gray-300 focus:outline-none focus:border-[#003787]/40 transition-all"
                            />
                        </div>
                    ))}
                </div>
                <div className="flex gap-3">
                    <button onClick={onClose} className="flex-1 h-10 border border-gray-200 rounded-xl text-[13px] font-bold text-[#0C0C0E] hover:bg-gray-50 transition-colors">Cancel</button>
                    <button onClick={handleAdd} className="flex-1 h-10 bg-[#003787] text-white rounded-xl text-[13px] font-bold hover:opacity-90 transition-opacity">Add staff</button>
                </div>
            </div>
        </div>
    );
...
export default function BusinessPAYE() {
    ...
    const ENTRY_OPTIONS: { id: typeof entryMethod; label: string }[] = [
            ...
            <main className="max-w-[1200px] mx-auto px-4 md:px-6 py-8">
                ...
                <div className="flex items-center gap-2 mb-6">
                    ...
                    <div className="flex items-center gap-1.5 text-[12px] text-[#9CA3AF] font-medium">
                        ...
                        <span className="text-[#6B7280]">{view === 'monthly' ? 'Monthly Filing' : 'Annual Returns'}</span>
                    </div>
                </div>
                ...
                <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="flex items-center border border-gray-200 rounded-xl overflow-hidden bg-white">
                        <button
                            ...
                            className={`px-4 py-2 text-[13px] font-bold transition-colors ${view === 'monthly' ? 'bg-[#0C0C0E] text-white' : 'text-[#6B7280] hover:bg-gray-50'}`}
                        >
                            Monthly Filing
                        </button>
                        <button
                            onClick={() => setView('annual')}
                            className={`px-4 py-2 text-[13px] font-bold transition-colors ${view === 'annual' ? 'bg-[#0C0C0E] text-white' : 'text-[#6B7280] hover:bg-gray-50'}`}
                        >
                            Annual Returns
                        </button>
                    </div>
                ...
                {view === 'monthly' && step === 'method' && (
                    <div className="max-w-[480px] mx-auto">
                        <h2 className="text-[17px] font-bold text-[#0C0C0E] mb-1">How do you want to add payroll data?</h2>
                ...
                {view === 'monthly' && step === 'table' && (
                    <>
                        ...
                        <div className="flex items-center justify-between mb-3">
                            <h2 className="text-[15px] font-bold text-[#0C0C0E]">
                                Staff Payroll ({MONTHS[activeMonth]} 2026)
                            </h2>
                            <div className="flex items-center gap-2">
                                <button
                                    onClick={() => setShowAddStaff(true)}
                                    className="flex items-center gap-1 px-3 py-1.5 rounded-lg text-[12px] font-bold text-[#003787] hover:bg-blue-50 transition-colors border border-[#003787]/20"
                                >
                                ...
                                <button className="flex items-center gap-1 px-3 py-1.5 rounded-lg text-[12px] font-bold text-[#0C0C0E] hover:bg-gray-100 transition-colors border border-gray-200">
                                    ...
                                    <thead className="bg-[#F9FAFB] border-b border-gray-100">
                                        <tr>
                                            {['Surname', 'Email Address', 'Phone number', 'Job position', 'Nationality', 'JRB Tax ID', 'Gross income'].map(col => (
                                                <th key={col} className="px-4 py-3 font-bold text-[#6B7280] whitespace-nowrap">{col}</th>
                                            ))}
                                            {/* Pension checkbox header */}
                                            <th className="px-4 py-3 font-bold text-[#6B7280] whitespace-nowrap">
                                                <div className="flex items-center gap-1.5">
                                                    <div className="w-3.5 h-3.5 rounded border-2 border-[#003787] bg-[#003787] flex items-center justify-center flex-shrink-0">
                                            ...
                                            <th className="px-4 py-3 font-bold text-[#6B7280] whitespace-nowrap">Chargeable income</th>
                                        </tr>
                                    </thead>
                                        ...
                                        {staff.map(emp => {
                                            ...
                                            return (
                                                <tr key={emp.id} className="hover:bg-[#FAFAFA] transition-colors">
                                                    <td className="px-4 py-3 font-semibold text-[#0C0C0E] whitespace-nowrap">{emp.name}</td>
                                                    <td className="px-4 py-3 text-[#6B7280] whitespace-nowrap">{emp.email}</td>
                                                    <td className="px-4 py-3 text-[#6B7280] whitespace-nowrap">{emp.phone}</td>
                                                    <td className="px-4 py-3 text-[#6B7280] whitespace-nowrap">{emp.position}</td>
                                                    <td className="px-4 py-3 text-[#6B7280] whitespace-nowrap">{emp.nationality}</td>
                                                    <td className="px-4 py-3 text-[#6B7280] font-mono whitespace-nowrap">{emp.taxId}</td>
                                                    <td className="px-4 py-3 font-bold text-[#0C0C0E] whitespace-nowrap">{fmtN(emp.gross)}</td>
                                                    {/* Pension */}
                                                    <td className="px-4 py-3 whitespace-nowrap">
                                                        <div className="flex items-center gap-2">
                                                            <button
                                                                onClick={() => togglePension(emp.id)}
                                                                className={`w-3.5 h-3.5 rounded border-2 flex items-center justify-center flex-shrink-0 transition-colors ${emp.pensionOn ? 'border-[#003787] bg-[#003787]' : 'border-gray-300 bg-white'}`}
                                                            >
                                                                {emp.pensionOn && (
                                                                    <svg width="8" height="8" viewBox="0 0 12 12" fill="none">
                                                                        <path d="M2 6L5 9L10 3" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                                            ...
                                                            <span className={`font-semibold ${emp.pensionOn ? 'text-[#0C0C0E]' : 'text-[#9CA3AF]'}`}>{fmtN(pension)}</span>
                                                        </div>
                                                    </td>
                                                    {/* NHF */}
                                                    <td className="px-4 py-3 whitespace-nowrap">
                                                        <div className="flex items-center gap-2">
                                                            <button
                                                                ...
                                                                className={`w-3.5 h-3.5 rounded border-2 flex items-center justify-center flex-shrink-0 transition-colors ${emp.nhfOn ? 'border-[#003787] bg-[#003787]' : 'border-gray-300 bg-white'}`}
                                                            >
                                                                {emp.nhfOn && (
                                                                    <svg width="8" height="8" viewBox="0 0 12 12" fill="none">
                                                                        <path d="M2 6L5 9L10 3" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                                            ...
                                                            <span className={`font-semibold ${emp.nhfOn ? 'text-[#0C0C0E]' : 'text-[#9CA3AF]'}`}>{fmtN(nhf)}</span>
                                                        </div>
                                                    </td>
                                                    {/* Chargeable */}
                                                    <td className="px-4 py-3 font-semibold text-[#0C0C0E] whitespace-nowrap">{fmtN(chargeable)}</td>
                                                </tr>
                                            );
                                        })}
                                                ...
                                                <td key={i} className="px-4 py-3">
                                                    {ph ? (
                                                        <input
                                                            type="text"
                                                            placeholder={ph}
                                                            className="w-full bg-transparent text-[12px] font-medium text-[#9CA3AF] placeholder:text-[#D1D5DB] border-none outline-none"
                                                        />
                                                    ) : <div className="w-6" />}
                                                </td>
                                            ))}
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-[12px] font-semibold text-[#6B7280] mb-0.5">Total PAYE due this month</p>
                                <p className="text-[28px] font-bold text-[#0C0C0E]">{fmtN(totalPAYE)}</p>
                            </div>
                            <button
                                onClick={() => setShowFilingModal(true)}
                                className="h-12 px-6 bg-[#003787] text-white font-bold rounded-xl hover:opacity-90 transition-opacity text-[14px]"
                            >
                        ...
                        <div className="max-w-[680px] mx-auto">
                            ...
                            <div className="space-y-3 mb-7">
                                {[
                                    ...
                                    <div key={i} className="flex items-center gap-3">
                                        ...
                                        <span className="text-[14px] font-semibold text-[#0C0C0E]">
                                            {line.includes('months of payroll data') ? (
                                                <>
                                                    {`${staff.length * 12} months of payroll data `}
                                                    <span className="text-[#6B7280] font-medium">({staff.length} staffs x 12 months)</span>
                                                </>
                                            ) : line}
                                        </span>
                                    </div>
                            ...
                            <div className="mb-6">
                                <div className="flex items-center gap-1.5 mb-1.5">
                                    <label className="text-[13px] font-bold text-[#0C0C0E]">Payer ID</label>
                                    <div className="relative group">
                                        <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#9CA3AF" strokeWidth="2">
                                            <circle cx="12" cy="12" r="10" /><line x1="12" y1="16" x2="12" y2="12" /><line x1="12" y1="8" x2="12.01" y2="8" />
                                        </svg>
                                        <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-52 p-2 bg-gray-800 text-white text-[11px] rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-20 font-medium">
                                ...
                                <input
                                    ...
                                    className="w-full h-11 border border-gray-200 rounded-xl px-4 text-[14px] font-medium text-[#0C0C0E] placeholder:text-gray-300 focus:outline-none focus:border-[#003787]/40 transition-all"
                                />
                                <div className="flex items-center gap-1 mt-2">
                                    ...
                                    <p className="text-[12px] text-[#9CA3AF] font-medium">
                                        ...
                                        <a href="#" className="text-[#003787] font-bold hover:underline">Apply here</a>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-3 mb-8">
                                ...
                                <button className="flex-1 h-12 bg-[#003787] text-white font-bold rounded-xl hover:opacity-90 transition-opacity text-[14px]">
                                    Submit to LIRS
                                </button>
                            </div>
                            ...
                            {showBreakdown && (
                                <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
                                    {/* Tabs */}
                                                ...
                                                <thead className="bg-[#F9FAFB] border-b border-gray-100">
                                                    <tr>
                                                        {['Month', 'Gross Payroll', 'PAYE Due', 'Date Filed', 'Status'].map(h => (
                                                            <th key={h} className="px-5 py-3 font-bold text-[#6B7280]">{h}</th>
                                                        ))}
                                                    </tr>
                                                </thead>
                                                <tbody className="divide-y divide-gray-50">
                                                    {MONTHS.map((m, i) => (
                                                        <tr key={m} className="hover:bg-[#FAFAFA] transition-colors">
                                                            <td className="px-5 py-3 font-semibold text-[#0C0C0E]">{m}</td>
                                                            <td className="px-5 py-3 text-[#0C0C0E] font-medium">{fmtN(monthlyGross)}</td>
                                                            <td className="px-5 py-3 text-[#0C0C0E] font-medium">{fmtN(monthlyPAYE)}</td>
                                                            <td className="px-5 py-3 text-[#6B7280]">{FILED_DATES[i]}</td>
                                    ...
                                    {breakdownTab === 'levy' && (
                                        <div className="p-5">
                                            <p className="text-[13px] text-[#6B7280] font-medium leading-relaxed mb-5">
                                                Development Levy is a <strong className="text-[#0C0C0E]">4%</strong> additional tax on employees with annual chargeable income above ₦1,000,000.{' '}
                                                <strong className="text-[#0C0C0E]">{levyStaff.length} out of {staff.length} employees</strong> qualify for Development Levy
                                            </p>
                                            <table className="w-full text-left text-[13px] mb-5">
                                                <thead className="border-b border-gray-100">
                                                    <tr>
                                                        {['Employee Name', 'Chargeable Income', 'Levy'].map(h => (
                                                            <th key={h} className="pb-2 font-bold text-[#6B7280]">{h}</th>
                                                        ))}
                                                    </tr>
                                                </thead>
                                                <tbody className="divide-y divide-gray-50">
                                                    {levyStaff.map((e, i) => (
                                                        <tr key={i} className="hover:bg-[#FAFAFA] transition-colors">
                                                            <td className="py-3 font-semibold text-[#0C0C0E]">{e.name}</td>
                                                            <td className="py-3 text-[#0C0C0E] font-medium">{fmtN(e.chargeable)}</td>
                                                            <td className="py-3 font-bold text-[#0C0C0E]">{fmtN(e.levy)}</td>
                                                        </tr>
                                                    ))}
                                                </tbody>
                                            </table>
                                            <div className="border-t border-gray-100 pt-4">
                                                <p className="text-[12px] font-semibold text-[#6B7280] mb-1">Total Levy</p>
                                                <p className="text-[24px] font-bold text-[#0C0C0E]">{fmtN(totalLevy)}</p>
                                            </div>
                                        </div>
                                    )}
                                </div>

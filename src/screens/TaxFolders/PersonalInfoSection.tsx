...
export const PersonalInfoSection = ({
    ...
    <div className="flex flex-col md:flex-row items-start justify-between gap-6 md:gap-12">
        ...
        <div className="flex-1 space-y-5 md:space-y-7 w-full max-w-[480px]">
            <h2 className="text-[14px] font-medium text-taxable-gray" style={{ fontFamily: 'Archivo', lineHeight: '20px', letterSpacing: '-0.6%' }}>Personal Information</h2>
            ...
            <div>
                ...
                <input
                    ...
                    readOnly
                    className="w-full h-11 bg-neutral-50 rounded-xl px-4 text-[14px] font-medium text-neutral-500 cursor-not-allowed focus:outline-none"
                />
            </div>

            {/* Residency status */}
            <div className="flex justify-between items-center bg-neutral-50 p-4 rounded-xl">
                <div className="flex items-center gap-1.5 text-[14px] font-medium text-taxable-gray" style={{ fontFamily: 'Archivo', lineHeight: '20px', letterSpacing: '-0.6%' }}>
                    Residency status
                ...
                <div className="flex items-center gap-1.5 text-[14px] font-semibold text-green-600">
            ...
            <div>
                ...
                <input
                    ...
                    className="w-full h-11 bg-white rounded-xl px-4 text-[14px] font-medium text-neutral-800 focus:outline-none transition-all placeholder:text-neutral-300"
                />
            </div>
            ...
            <div>
                ...
                <input
                    ...
                    className="w-full h-11 bg-white rounded-xl px-4 text-[14px] font-medium text-neutral-800 focus:outline-none transition-all"
                />
            </div>
            ...
            <div>
                ...
                <input
                    ...
                    className="w-full h-11 bg-white rounded-xl px-4 text-[14px] font-medium text-neutral-800 focus:outline-none transition-all placeholder:text-neutral-300 mb-3"
                />
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div className="relative">
                        <label className="flex items-center gap-1 text-1 font-medium text-taxable-gray mb-1">
                            City
                            <InfoTooltip text="The city where your residential address is located." />
                        </label>
                        <select
                            className="appearance-none w-full h-11 bg-white rounded-xl px-4 text-[14px] font-medium text-neutral-800 focus:outline-none transition-all"
            ...
            <button
                ...
                className="h-12 px-10 bg-taxable-blue text-white font-bold rounded-xl hover:opacity-90 transition-all disabled:opacity-50"
            >
        ...
        <div className="hidden md:block w-[300px] flex-shrink-0 sticky top-8 self-start">
            <div className="bg-neutral-100 rounded-3xl p-6">
                ...
                <div className="flex items-center gap-2.5 mb-4">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" className="text-neutral-800" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <circle cx="12" cy="12" r="10" />
                        <line x1="12" y1="8" x2="12" y2="8" strokeWidth="3" strokeLinecap="round" />
                        <line x1="12" y1="12" x2="12" y2="16" />
                    </svg>
                    <h3 className="text-[16px] font-bold text-neutral-800">Why we need this</h3>
                </div>

                {/* Body */}
                <p className="text-2 text-taxable-gray mb-8" style={{ fontFamily: 'Archivo', fontWeight: 500, lineHeight: '160%', letterSpacing: '-0.6%' }}>
                ...
                <div className="space-y-4">
                    <a
                        ...
                        className="flex items-center gap-3 text-3 font-bold text-neutral-800 hover:opacity-70 transition-opacity"
                    >

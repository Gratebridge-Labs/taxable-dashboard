...
>(({ className, children, ...props }, ref) => (
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ref={ref}
      className={cn(
        "fixed inset-x-0 bottom-0 z-50 mt-24 flex flex-col rounded-t-3xl bg-white max-h-[95vh]",
        className
      )}
      {...props}
    >
...
const DrawerHeader = ({
  ...
  <div
    className={cn("grid gap-1.5 px-4 pt-4 text-center sm:text-left", className)}
    {...props}
  />
);

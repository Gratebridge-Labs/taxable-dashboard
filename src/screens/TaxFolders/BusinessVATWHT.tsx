...
import {
    ...
    InfoTooltip, FilingSheet, CardTitle, CardContainer, FormFieldRow, FormLabel, MonthList,
    UploadContainer,
...
export function BusinessVATWHTContent() {
    ...
    const subSection = internalSubSection;
    const setSubSectionLocal = setInternalSubSection;

            ...
            <div className="min-h-screen bg-white">
                ...
                <div className="max-w-[800px] mx-auto pt-16 px-6">
                    <div className="animate-pulse">
                        ...
                        <div className="h-12 w-3/4 bg-neutral-100 rounded mb-6" />
                        <div className="h-6 w-1/4 bg-neutral-100 rounded mb-12" />
                        <div className="aspect-[21/9] w-full bg-neutral-100 rounded-4xl mb-12" />
        ...
        <div className="min-h-screen bg-white selection:bg-taxable-blue/10 selection:text-taxable-blue">
            ...
            >
                ...
                {(blog.featuredImage || blog.coverImage) && (
                    <div className="relative aspect-[21/10] w-full rounded-4xl overflow-hidden mb-12 shadow-2xl shadow-taxable-blue/10">
                        <Image

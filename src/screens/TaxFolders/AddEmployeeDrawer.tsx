                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm bg-black/20" onClick={() => setShowRemoveConfirm(false)}>
                        <div className="bg-white rounded-2xl p-6 max-w-[400px] mx-4 w-full shadow-2xl" onClick={(e) => e.stopPropagation()}>
                            <div className="flex flex-col items-center text-center">
                                ...
                                <h3 className="text-5 font-semibold text-neutral-800 mb-2">Remove Employee?</h3>
    ...
    return (
        <>
            <div className="grid grid-cols-2 gap-8 mb-8">
                <div>
                    <label className="block text-2 font-medium text-neutral-700 mb-1">First Name</label>
                ...
                <div>
                    <label className="block text-2 font-medium text-neutral-700 mb-1">Last Name</label>
                ...
                <div>
                    <label className="block text-2 font-medium text-neutral-700 mb-1">Email</label>
                ...
                <div>
                    <label className="block text-2 font-medium text-neutral-700 mb-1">Phone Number</label>
                ...
                <div>
                    <label className="block text-2 font-medium text-neutral-700 mb-1">Job Position</label>
                ...
                <div>
                    <label className="block text-2 font-medium text-neutral-700 mb-1">JRB Tax ID</label>

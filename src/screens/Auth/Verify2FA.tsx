            ...
            <OnboardingLayout>
                <div className="flex-1 flex flex-col justify-center relative">
                    <div ref={formRef} className="max-w-[420px] w-full mx-auto">
                        <div className="mb-10">
                            <h2 data-animate className="text-5 font-medium text-taxable-dark mb-1 tracking-[-0.02em] font-[family-name:var(--font-merriweather)]">Two-Factor Authentication</h2>

  ...
  ({ asChild = false, className, children, ...props }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "relative flex size-5 shrink-0 items-center justify-center rounded-full bg-neutral-50 text-xs font-medium text-neutral-400 data-[state=active]:bg-neutral-800 data-[state=completed]:bg-neutral-800 data-[state=active]:text-white data-[state=completed]:text-white",
          className,
        )}
        data-state={state}
        {...props}

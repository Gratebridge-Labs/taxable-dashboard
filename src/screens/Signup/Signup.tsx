            ...
            <OnboardingLayout>
                <div className="max-w-[420px] mx-auto w-full">
                    <div className="flex justify-between items-start mb-[40px]">
                        ...
                        <Link href="/signin" className="h-10 px-4 flex items-center justify-center rounded-xl border border-neutral-200 text-taxable-dark font-medium text-2 hover:bg-gray-50 transition-colors bg-white shrink-0">
                            Log in
                        </Link>
                    </div>

...
export default function DashboardHeader() {
    ...
    return (
        <header className="w-full h-16 bg-neutral-100 border-b border-neutral-100 sticky top-0 z-50">
            <div className="max-w-[1400px] mx-auto w-full h-full flex items-center px-4 md:px-8">
                ...
                <div className="flex-1 flex items-center gap-3">
                    <button
                        ...
                        className="md:hidden p-2 -ml-2 text-taxable-dark hover:bg-neutral-50 rounded-lg transition-colors"
                    >
                        ...
                        return (
                            <Link
                                ...
                                className={`flex items-center gap-2.5 px-3 py-2 rounded-xl transition-all ${isActive
                                    ...
                                    : 'text-taxable-gray font-medium hover:text-taxable-dark hover:bg-neutral-50'
                                    }`}
                                title={link.name}
                            >
                                {link.icon}
                ...
                <div className="flex-1 flex items-center justify-end gap-3 md:gap-4 relative">
                    <button
                        ...
                        className="px-3 md:px-5 h-[42px] md:h-[46px] border-none bg-white rounded-[12px] text-2 md:text-[14px] font-bold text-taxable-dark hover:bg-neutral-50 transition-all cursor-pointer flex items-center gap-2"
                    >
                        ...
                        <>
                            ...
                            <div className="absolute top-full mt-2 right-0 w-[280px] bg-white border border-neutral-100 rounded-4xl shadow-xl p-4 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                                <div className="flex flex-col gap-1">
                                    <button className="flex items-center gap-4 px-4 py-3 rounded-2xl hover:bg-neutral-50 transition-colors text-taxable-dark text-[14px] font-semibold text-left">
                                    ...
                                    <a href="mailto:support@taxable.ng" className="flex items-center gap-4 px-4 py-3 rounded-2xl hover:bg-neutral-50 transition-colors text-taxable-dark text-[14px] font-semibold">
                                    ...
                                    return (
                                        <Link
                                            ...
                                            className={`flex items-center gap-4 px-4 py-4 rounded-2xl transition-all ${isActive
                                                ...
                                                : 'text-taxable-gray font-semibold hover:bg-neutral-50 hover:text-taxable-dark'
                                                }`}
                                        >
                                            <div className={`${isActive ? 'text-taxable-blue' : 'text-neutral-400'}`}>
                                                {link.icon}
                                            </div>
